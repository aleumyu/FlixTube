...
const STORAGE_ACCOUNT_NAME = process.env.STORAGE_ACCOUNT_NAME || 'flixtube';
const STORAGE_ACCESS_KEY =
  process.env.STORAGE_ACCESS_KEY ||
  'rSoQX/YgzAjVF5RJuo6/sQ/x4wQt8mK2wZDaBjq9DRZIP4u6SoNq/4ILrJ2UP5BnKSBIf2ULGyPLFEGk9mDLpA==';
console.log(
